...
// Para uso na placa comprada pronta no Aliexpress
// Placa de Wilton
static const struct dvi_serialiser_cfg picodvi_dvi_cfg_wil = {
	.pio = DVI_DEFAULT_PIO_INST,
	.sm_tmds = {0, 1, 2},
	.pins_tmds = {10, 12, 14},
    .pins_clk = 8,
...
// Para uso na BitDogLab com o adaptador PicoDVI
